<h3 class="headers gray">{'edit_group'|@Lang}</h3>
{$form_open}
	<fieldset>
		<ul>
			<li>
				...
				<span>
					<input id="title" name= "title" class="element text" size="40" value="{'title'|@form_validation_get_value:$row->title}" />
			...
			<li>
				...
				<span>
					<input id="login_redirect" name= "login_redirect" class="element text" size="40" value="{'login_redirect'|@form_validation_get_value:$row->login_redirect}" />
			...
			<li>
				...
				<span>
					<input id="logout_redirect" name= "logout_redirect" class="element text" size="40" value="{'logout_redirect'|@form_validation_get_value:$row->logout_redirect}" />
