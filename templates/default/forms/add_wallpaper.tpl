...
<fieldset class="active">
	<ul>
		...
		<li>
			...
			<div>
				<input id="file_title" name= "file_title" class="element text large" size="40" value="{'file_title'|@form_validation_get_value}" />
		...
		<li>
			...
			<div>
				<input id="title_alias" name="title_alias" class="element text large" size="40" value="{'title_alias'|@form_validation_get_value}" />
		...
		<li>
			...
			<div>
				<textarea name="description" class="element textarea small">{'description'|@form_validation_get_value}</textarea>
		...
		<li>
			...
			<div>
				<textarea name="keywords" class="element textarea small">{'keywords'|@form_validation_get_value}</textarea>
