<?php /* Smarty version 2.6.25, created on 2009-12-26 01:07:49
         compiled from default/html/highest_rated.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'Lang', 'default/html/highest_rated.tpl', 1, false),array('modifier', 'make_thumb_if_not_exists', 'default/html/highest_rated.tpl', 1, false),array('modifier', 'get_wallpaper_url_location', 'default/html/highest_rated.tpl', 1, false),array('modifier', 'get_wallpaper_url', 'default/html/highest_rated.tpl', 1, false),array('modifier', '__character_limiter', 'default/html/highest_rated.tpl', 1, false),)), $this); ?>
<div id="centercol"><h3><?php echo ((is_array($_tmp='highest_rated')) ? $this->_run_mod_handler('Lang', true, $_tmp) : Lang($_tmp)); ?>
...
"><span class="ui-icon ui-icon-check" style="-moz-user-select: none;">&nbsp;</span>[ <?php echo $this->_tpl_vars['row']->rating; ?>
